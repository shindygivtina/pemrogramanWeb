<x-admin-layout>
<h1 class="text-4xl text-black pb-6">Kalender</h1>
    ...
    <script>
		const MONTH_NAMES = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Augustus', 'September', 'Oktober', 'November', 'Desember'];
